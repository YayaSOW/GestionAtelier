<div class="flex-1 flex flex-col">
    <div class="container mb-5">
        <div class="max-w-md mx-auto bg-white shadow-md rounded-md p-4">
            <div class="bg-gray-100 text-gray-800 font-bold p-2">Modifier Article</div>
            <form action="<?= WEBROOT ?>" method="post">
                <div class="">
                    <input name="id_article" value="<?= $article["id_article"] ?>" type="" class="hidden"
                        id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-4">
                    <label for="Libelle" class="block text-sm font-bold mb-2">Libelle</label>
                    <input name="libelle" type="text" value="<?= $article["libelle"] ?>"
                ...
                <div class="mb-4">
                    ...
                    <input name="qteStock" type="number" value="<?= $article["qteStock"] ?>"
                        class="block w-full p-2 pl-10 text-sm text-gray-700 placeholder-gray-400 border border-gray-300 rounded-md focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out"
                        id="QteStock" aria-describedby="emailHelp">
                </div>
                <div class="mb-4">
                    <label for="Prix" class="block text-sm font-bold mb-2">Prix</label>
                    <input name="prixAppro" type="number" value="<?= $article["prixAppro"] ?>"
                        class="block w-full p-2 pl-10 text-sm text-gray-700 placeholder-gray-400 border border-gray-300 rounded-md focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out"
                ...
                <div class="mb-4">
                    ...
                    <select name="typeId"
                        ...
                        <option selected><?= $article["nomType"] ?></option>
                        <?php
                ...
                <div class="mb-4">
                    ...
                    <select name="categorieId"
                        ...
                        <option selected><?= $article["nomCategorie"] ?></option>
                        <?php
                ...
                <div class="flex justify-end">
                    <input type="text" class="hidden" name="action" value="valide-modification-article">
